...
#   ),
  fluidRow(
    column(width = 4, box(collapsible = FALSE, width = NULL, title = "Control Panel", height = "420px",
    ...
    column(width = 3, box(collapsible = FALSE, width = NULL, title = "Live Status", height = "420px",
                          valueBoxOutput("current_delaychance", width = 12),
                          uiOutput(outputId = "currentcond")
                          )
    ),
    column(width = 5, box(collapsible = FALSE, width = NULL, title = "Explanation of Effect", height = "420px",
