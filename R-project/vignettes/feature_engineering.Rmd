...
```{r}
# write.csv(x = sql_data, file="~/Repos/NJT-DelayPredictor/data/njt_features.csv", row.names = FALSE)
```
...
# write.csv(tr_ds, file = "~/Repos/NJT-DelayPredictor/data/njt_features_downsampled.csv", row.names = FALSE)
