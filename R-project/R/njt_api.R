...
hourly_newark <- "http://api.wunderground.com/api/547710b840da62b4/hourly/q/NJ/Newark.json"
wu_get <- GET(hourly_newark)
wu_content <- content(wu_get, as = "text")
wu_text <- fromJSON(wu_content)
wu_text %>% data.frame %>% View
